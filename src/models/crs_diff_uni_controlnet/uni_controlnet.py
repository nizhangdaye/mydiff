...
class SatelliteUniControlNet(ControlNetModel):
    """
    ...
    def __init__(
        ...
        use_metadata=False,
        num_metadata=7,
        use_local_adapter_injection=True,
        local_adapter_inject_channels=(192, 256, 384, 512),
        *args,
        **kwargs,
    ):
        super().__init__(*args, **kwargs)

        # 立即删除 controlnet_cond_embedding，释放内存
    ...
    def forward(
        ...
        uni_local_adapter_cond: torch.Tensor,  # local adapter cond
...
if __name__ == "__main__":
    ...
    uni_controlnet = SatelliteUniControlNet.from_unet(unet, conditioning_in_channels=6)
    # 打印模型结构
    ...
    uni_controlnet(
        ...
        uni_local_adapter_cond=torch.randn(1, 6, 512, 512),
    )
