...
export OUT_DIR="/mnt/data/zwh/log/instruct-pix2pix-CRS-UniControlNet/experiment_0"
# 离线模式
export HF_HUB_OFFLINE=1
export TRANSFORMERS_OFFLINE=1
export HF_DATASETS_OFFLINE=1

accelerate launch --config_file="$1" --mixed_precision="fp16" --main_process_port=43736  --gpu_ids="$CUDA_VISIBLE_DEVICES"  train_instruct_pix2pix_CRS_Uni_ControlNet.py \
